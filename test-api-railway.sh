#!/bin/bash
# test-api-railway.sh - Complete API Testing Script for Railway Deployment
...
# Base URL for Railway
BASE_URL="https://franchise-management-api-railway-production.up.railway.app/api/v1"

echo -e "${BLUE}🧪 Franchise Management API - Railway Testing${NC}"
echo "================================================="
echo -e "${YELLOW}URL: https://franchise-management-api-railway-production.up.railway.app${NC}"
echo ""
...
# 0. HEALTH CHECK
print_section "0️⃣  HEALTH CHECK"
echo "Checking if the API is running..."
curl -s https://franchise-management-api-railway-production.up.railway.app/actuator/health | jq .
print_test "API is running on Railway!"
...
echo -e "${GREEN}All API endpoints tested successfully on Railway!${NC}"
echo ""
...
echo ""
echo -e "${BLUE}🎉 Railway deployment is working perfectly!${NC}"
echo -e "${YELLOW}URL: https://franchise-management-api-railway-production.up.railway.app${NC}"